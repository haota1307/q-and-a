...
const QuestionsSortBySelect = ({ sortBy }: Props) => {
  ...
  return (
    ...
    >
      ...
      <SelectContent>
        ...
        <SelectItem value={"newest" as QuestionsOrderBy}>Mới nhất</SelectItem>
        <SelectItem value={"oldest" as QuestionsOrderBy}>Cũ nhất</SelectItem>
      </SelectContent>
    </Select>
  );
};

export default QuestionsSortBySelect;
